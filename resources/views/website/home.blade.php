        ...
        <div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
          ...
          <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
            ...
            <div class="item">
              <div class="products">
                <div class="hot-deal-wrapper">
                  <div class="image"> <img src="{{asset('assets/website/images/hot-deals/p5.jpg')}}" alt=""> </div>
            ...
            <div class="item">
              <div class="products">
                <div class="hot-deal-wrapper">
                  <div class="image"> <img src="{{asset('assets/website/images/hot-deals/p10.jpg')}}" alt=""> </div>
                  <div class="sale-offer-tag"><span>35%<br>
                    off</span></div>
                  <div class="timing-wrapper">
                    <div class="box-wrapper">
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{asset('assets/website/images/products/p4.jpg')}}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{asset('assets/website/images/products/p29.jpg')}}" alt=""></a> </div>
                          <!-- /.image -->
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{asset('assets/website/images/products/p7.jpg')}}" alt=""></a> </div>
                          <!-- /.image -->
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{asset('assets/website/images/products/p11.jpg')}}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{asset('assets/website/images/products/p12.jpg')}}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{asset('assets/website/images/products/p13.jpg')}}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="{{asset('assets/website/images/products/p14.jpg')}}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{asset('assets/website/images/products/p15.jpg')}}" alt="image"></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="{{asset('assets/website/images/products/p16.jpg')}}" alt=""></a> </div>
                          <!-- /.image -->
                ...
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="{{asset('assets/website/images/products/p18.jpg')}}" alt=""></a> </div>
                          <!-- /.image -->
                  ...
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img  src="{{asset('assets/website/images/products/p17.jpg')}}" alt=""></a> </div>
                          <!-- /.image -->
          ...
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
            ...
            <div class="item item-carousel">
              <div class="products">
                <div class="product">
                  <div class="product-image">
                    <div class="image"> <a href="detail.html"><img  src="{{asset('assets/website/images/blank.gif')}}" data-echo="assets/images/products/p7.jpg" alt=""></a> </div>
                    <!-- /.image -->
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{asset('assets/website/images/products/p20.jpg')}}" alt=""> </a> </div>
                            <!-- /.image --> 
                  ...
                  <div class="product">
                    <div class="product-micro">
                      <div class="row product-micro-row">
                        <div class="col col-xs-5">
                          <div class="product-image">
                            <div class="image"> <a href="#"> <img src="{{asset('assets/website/images/products/p21.jpg')}}" alt=""> </a> </div>
                            <!-- /.image --> 
    ...
    <div id="brands-carousel" class="logo-slider wow fadeInUp">
      <div class="logo-slider-inner">
        <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
          ...
          <div class="item m-t-10"> <a href="#" class="image"> <img data-echo="{{asset('assets/website/images/brands/brand2.png')}}" src="assets/images/blank.gif')}}" alt=""> </a> </div>
          <!--/.item-->
          ...
          <div class="item"> <a href="#" class="image"> <img data-echo="{{asset('assets/website/images/brands/brand5.png" src="assets/images/blank.gif')}}" alt=""> </a> </div>
          <!--/.item--> 
        </div>
