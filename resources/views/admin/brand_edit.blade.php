                                    ...
                                    @csrf
                                        <div class="form-group">
											...
											<input type="hidden" name="id" value="{{ $row['id'] }}">
                                                <input type="text" class="form-control" name="brand_name" id="brand_name" placeholder="Brand Name" data-validation="required" value="{{ $row['brand_name'] }}">
                                                @error('brand_name')
